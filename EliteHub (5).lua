...
do
    ...
    _Sub.Size = UDim2.new(0.7, 0, 0.05, 0)
    _Sub.Position = UDim2.new(0.15, 0, 0.44, 0)
    _Sub.BackgroundTransparency = 1
    _Sub.Text = 'discord.gg/EmsMsHZCVH'
    _Sub.TextColor3 = Color3.fromRGB(180, 180, 180)
    ...
    _BarBG.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
    _BarBG.BorderSizePixel = 0
    _BarBG.Parent = _BG

    local _BarCorner = Instance.new('UICorner')
    _BarCorner.CornerRadius = UDim.new(1, 0)
    _BarCorner.Parent = _BarBG
    ...
    local _BarFillCorner = Instance.new('UICorner')
    _BarFillCorner.CornerRadius = UDim.new(1, 0)
    _BarFillCorner.Parent = _Bar

    local _Pct = Instance.new('TextLabel')
    _Pct.Size = UDim2.new(0.6, 0, 0.05, 0)
    _Pct.Position = UDim2.new(0.2, 0, 0.60, 0)
    _Pct.BackgroundTransparency = 1
    _Pct.Text = 'Loading... 0%'
    _Pct.TextColor3 = Color3.fromRGB(220, 220, 220)
    ...
    for i = 1, 100 do
        _tween:Create(_Bar, TweenInfo.new(0.025, Enum.EasingStyle.Linear), {
...
local _VScript = u2.CreateLib('Elite Hub', 'BloodTheme')
local _Esp = _VScript:NewTab('Esp')
...
if Second_Sea then
    local _Here = _VScript:NewTab('Raid...'):NewSection('Here')
...
if Third_Sea then
    local _Here2 = _VScript:NewTab('Raid...'):NewSection('Here')
...
if First_Sea then
    _VScript:NewTab('Raid...'):NewSection('Here'):NewLabel('U need to go Second/Third Sea!')
end

local _Here3 = _VScript:NewTab('Farm...'):NewSection('Here')
...
local _Here4 = _VScript:NewTab('Teleport...'):NewSection('Here')
...
local _here = _VScript:NewTab('Stats...'):NewSection('here')
...
local _Here5 = _VScript:NewTab('Misc...'):NewSection('Here')
...
_Here5:NewLabel('BackToEliteHub')
_Here5:NewButton('Go back to Elite Hub?', '', function()
    print(loadstring(game:HttpGet('https://raw.githubusercontent.com/KevinGithubUsers/KevinGithubUsers/main/VScript', true))())
end)

local _here2 = _VScript:NewTab('Player...'):NewSection('here')
...
local _here3 = _VScript:NewTab('RaceV4...'):NewSection('here')
...
local _here4 = _VScript:NewTab('Shop...'):NewSection('here')
...
if Third_Sea then
    local _here5 = _VScript:NewTab('Sea...'):NewSection('here')
...
_VScript:NewTab('?'):NewSection('here')
