-- Elite Hub | Discord: https://discord.gg/EmsMsHZCVH


-- Elite Hub Loading Screen
do
    local Players = game:GetService("Players")
    local player = Players.LocalPlayer
    local gui = Instance.new("ScreenGui")
    gui.Name = "EliteHubLoading"
    ...
    progress.Position = UDim2.new(0,0,0.48,0)
    ...
    for i = 1,100 do
        progress.Text = "Loading Elite Hub... "..i.."%"
        task.wait(0.03)
    end
...
local u2 = loadstring(game:HttpGet('https://raw.githubusercontent.com/KevinGithubUsers/KevinGithubUsers/refs/heads/main/KevinLibraryUi.txt'))()
local _Elite Hub = u2.CreateLib('Elite Hub', 'BloodTheme')
local _Esp = _Elite Hub:NewTab('Esp')
...
function BTP(p215)
    pcall(function()
        if (p215.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000 and (not Auto_Raid and 0 < game.Players.LocalPlayer.Character.Humanoid.Health) then
...
local _Esp2 = _Esp:NewSection('Esp...')

_Esp2:NewToggle('Esp Player', 'ESP PLAYER', function(p249)
    ESPPlayer = p249

    UpdatePlayerChams()
end)
_Esp2:NewToggle('Esp Devil Fruit', 'ESPFRUIT', function(p250)
    DevilFruitESP = p250
...
_Esp2:NewToggle('Esp Island', 'Esp Island', function(p251)
    IslandESP = p251
...
_Esp2:NewToggle('Esp Flower', 'Esp Flower(SecondSea)', function(p252)
    FlowerESP = p252
...
if Third_Sea then
    _Esp2:NewToggle('Esp Gear', '', function(p253)
        GearESP = p253

        UpdateGeaESP()
    end)
    _Esp2:NewToggle('Mirage Esp', '', function(p254)
        MirageIslandESP = p254

        UpdateIslandMirageESP()
    end)
    _Esp2:NewToggle('RealFruits Esp', '', function(p255)
        RealFruitESP = p255
...
if Second_Sea then
    _Esp2:NewToggle('ESP Legendary Sword Dealer', '', function(p256)
        LADESP = p256
...
_Esp2:NewLabel('TweenToFruit')
_Esp2:NewToggle('AutoTweenFruit', '', function(p257)
    _G.Tweenfruit = p257
end)
spawn(function()
    while wait(0.1) do
...
_Esp2:NewToggle('Store Fruit', '', function(p262)
...
_Esp2:NewToggle('AutoRandomFruit', '', function(p263)
    _G.Random_Auto = p263
end)
spawn(function()
    pcall(function()
...
if Second_Sea then
    local _Here = _Elite Hub:NewTab('Raid...'):NewSection('Here')

    _Here:NewDropdown('SelectChips', '', {
        'Flame',
        'Ice',
        'Quake',
        'Light',
    ...
    _Here:NewToggle('Buy Chip', '', function(p266)
    ...
    _Here:NewToggle('Auto Start Raid', '', function(p268)
    ...
    _Here:NewToggle('Kill Aura', '', function(p269)
        KillAura = p269
    end)
    spawn(function()
        while wait() do
                ...
                pcall(function()
                    ...
                    while true do
                        ...
                        if v273:FindFirstChild('Humanoid') and v273:FindFirstChild('HumanoidRootPart') and v273.Humanoid.Health > 0 then
                            ...
                            until not (KillAura and v273.Parent) or v273.Humanoid.Health <= 0
                        end
                    end
                end)
            end
    ...
    _Here:NewToggle('Auto Next Island', '', function(p274)
        AutoNextIsland = p274
    end)
    spawn(function()
        while task.wait() do
    ...
    _Here:NewToggle('Auto Awake', '', function(p275)
...
if Third_Sea then
    local _Here2 = _Elite Hub:NewTab('Raid...'):NewSection('Here')

    _Here2:NewDropdown('SelectChips', '', {
        'Flame',
        'Ice',
        'Quake',
        'Light',
    ...
    _Here2:NewToggle('Buy Chip', '', function(p278)
    ...
    _Here2:NewToggle('Auto Start Raid', '', function(p280)
    ...
    _Here2:NewToggle('Kill Aura', '', function(p281)
        KillAura = p281
    end)
    spawn(function()
        while wait() do
                ...
                pcall(function()
                    ...
                    while true do
                        ...
                        if v285:FindFirstChild('Humanoid') and v285:FindFirstChild('HumanoidRootPart') and v285.Humanoid.Health > 0 then
                            ...
                            until not (KillAura and v285.Parent) or v285.Humanoid.Health <= 0
                        end
                    end
                end)
            end
    ...
    _Here2:NewToggle('Auto Next Island', '', function(p286)
        AutoNextIsland = p286
    end)
    spawn(function()
        while task.wait() do
    ...
    _Here2:NewToggle('Auto Awake', '', function(p287)
...
if First_Sea then
    _Elite Hub:NewTab('Raid...'):NewSection('Here'):NewLabel('U need to go Second/Third Sea!')
end

local _Here3 = _Elite Hub:NewTab('Farm...'):NewSection('Here')

_Here3:NewDropdown('SelectWeapon', '', {
    'Melee',
    'Sword',
    'Blox Fruit',
}, function(p289)
...
_Here3:NewToggle('Auto Farm Level', '', function(p306)
    _G.AutoLevel = p306
end)
spawn(function()
    while task.wait() do
                ...
                if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) and game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false then
                    if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) or game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        ...
                        while true do
                            ...
                            if v310:FindFirstChild('Humanoid') and v310:FindFirstChild('HumanoidRootPart') and (v310.Humanoid.Health > 0 and v310.Name == Ms) then
                                repeat
                                    ...
                                    Click()
                                until not (_G.AutoLevel and v310.Parent) or v310.Humanoid.Health <= 0 or (not game:GetService('Workspace').Enemies:FindFirstChild(v310.Name) or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false)
                            end
                        end
                        ...
                        while true do
                            ...
                            if string.find(v314.Name, NameMon) and 10 <= (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v314.Position).Magnitude then
...
_Here3:NewToggle('Auto Farm Nearest', '', function(p315)
                ...
                while true do
                    ...
                    if v319:FindFirstChild('Humanoid') and v319:FindFirstChild('HumanoidRootPart') and (v319.Humanoid.Health > 0 and v319.Name) and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v319:FindFirstChild('HumanoidRootPart').Position).Magnitude <= 5000 then
                        repeat
                            ...
                            MonFarm = v319.Name
                        until not (_G.NeareastFarm and v319.Parent) or v319.Humanoid.Health <= 0 or not game.Workspace.Enemies:FindFirstChild(v319.Name)
...
if Second_Sea then
    _Here3:NewToggle('Auto Bartilo Quest', '', function(p320)
        _G.AutoBartilo = p320
    end)
    spawn(function()
        pcall(function()
    ...
    _Here3:NewToggle('Auto Farm Factory', '', function(p329)
        _G.Factory = p329
    end)
    spawn(function()
        while true do
        ...
        if v333.Name ~= 'Core' or 0 >= v333.Humanoid.Health then
        end
...
_Here3:NewLabel('Misc Farmable')

if Third_Sea then
    _Here3:NewToggle('Auto Farm Bone', '', function(p334)
        _G.Auto_Bone = p334
    end)
    spawn(function()
        while wait() do
                    ...
                    if game:GetService('Workspace').Enemies:FindFirstChild('Reborn Skeleton') or (game:GetService('Workspace').Enemies:FindFirstChild('Living Zombie') or game:GetService('Workspace').Enemies:FindFirstChild('Demonic Soul')) or game:GetService('Workspace').Enemies:FindFirstChild('Posessed Mummy') then
                        ...
                        while true do
                            ...
                            if (v338.Name == 'Reborn Skeleton' or v338.Name == 'Living Zombie' or (v338.Name == 'Demonic Soul' or v338.Name == 'Posessed Mummy')) and (v338:FindFirstChild('Humanoid') and v338:FindFirstChild('HumanoidRootPart') and v338.Humanoid.Health > 0) then
                                ...
                                until not (_G.Auto_Bone and v338.Parent) or v338.Humanoid.Health <= 0
                            end
                        end
                    else
    ...
    wait(0.1)
    _Here3:NewToggle('Auto Random Bone', '', function(p343)
    ...
    _Here3:NewToggle('Auto Elite Hunter', '', function(p344)
        _G.AutoElite = p344
    end)
    spawn(function()
        while task.wait() do
    ...
    if Second_Sea then
        _Here3:NewToggle('Auto Farm Ectoplasm', '', function(p349)
            _G.Ecto = p349
        end)
        spawn(function()
            while wait(0.1) do
...
if Third_Sea then
    _Here3:NewToggle('Auto Farm Cake Prince', '', function(p354)
        _G.CakePrince = p354
    end)
    spawn(function()
        while task.wait() do
                        ...
                        while true do
                            ...
                            if _G.CakePrince and v358.Name == 'Cake Prince' and (v358:FindFirstChild('HumanoidRootPart') and v358:FindFirstChild('Humanoid')) and v358.Humanoid.Health > 0 then
                                repeat
                                    ...
                                    BringMobs = false
                                until not (_G.CakePrince and v358.Parent) or v358.Humanoid.Health <= 0

                                BringMobs = true
                            end
                        end
                    elseif game:GetService('Workspace').Map.CakeLoaf.BigMirror.Other.Transparency == 0 and 2000 <= (CFrame.new(-1990.672607421875, 4532.99951171875, -14973.6748046875).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude then
                    ...
                    while true do
                        ...
                        if v362:FindFirstChild('Humanoid') and v362:FindFirstChild('HumanoidRootPart') and v362.Humanoid.Health > 0 and (v362.Name == 'Cookie Crafter' or v362.Name == 'Cake Guard' or (v362.Name == 'Baking Staff' or v362.Name == 'Head Baker')) and (v362:FindFirstChild('HumanoidRootPart') and v362:FindFirstChild('Humanoid') and v362.Humanoid.Health > 0) then
                            repeat
                                ...
                                game:GetService('VirtualUser'):CaptureController()
                                game:GetService('VirtualUser'):Button1Down(Vector2.new(1280, 672), workspace.CurrentCamera.CFrame)
                            until not (_G.CakePrince and v362.Parent) or v362.Humanoid.Health <= 0
                        end
                    end
                else
...
if Second_Sea then
    _Here3:NewToggle('Auto Buy Legendary Sword', '', function(p364)
...
if Third_Sea then
    _Here3:NewToggle('AutoHolyTorch', '', function(p365)
...
if Third_Sea then
    _Here3:NewToggle('Auto Yama', '', function(p366)
        _G.AutoYama = p366
    end)
    spawn(function()
        while wait() do
    ...
    _Here3:NewToggle('AutoTushita', '', function(p367)
        _G.Autotushita = p367
    end)
    spawn(function()
        while wait() do
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Longma [Lv. 2000] [Boss]') then
                        ...
                        while true do
                            ...
                            if v371.Name == 'Longma [Lv. 2000] [Boss]' and v371:FindFirstChild('Humanoid') and (v371:FindFirstChild('HumanoidRootPart') and 0 < v371.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
                                ...
                                until not (_G.Autotushita and v371.Parent) or v371.Humanoid.Health <= 0
                            end
                        end
                    else
    ...
    _Here3:NewToggle('Auto Cursed Dual Katana', '', function(p372)
        _G.AutoCdk = p372
    end)
    spawn(function()
        while wait() do
                        ...
                        if game:GetService('Workspace').Enemies:FindFirstChild('Soul Reaper [Lv. 2100] [Raid Boss]') or game.ReplicatedStorage:FindFirstChild('Soul Reaper [Lv. 2100] [Raid Boss]') then
                            if game:GetService('Workspace').Enemies:FindFirstChild('Soul Reaper [Lv. 2100] [Raid Boss]') then
                                ...
                                while true do
                                    ...
                                    if v405.Name == 'Soul Reaper [Lv. 2100] [Raid Boss]' and 0 < v405.Humanoid.Health then
                                        repeat
                                            wait()
                ...
                pcall(function()
                    if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 500 then
                        ...
                        while true do
                            ...
                            if Auto_Quest_Tushita_2 and v413:FindFirstChild('HumanoidRootPart') and (v413:FindFirstChild('Humanoid') and 0 < v413.Humanoid.Health) and (v413.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000 then
                                repeat
                                    wait()
            ...
            if Auto_Quest_Tushita_3 then
                pcall(function()
                    ...
                    while true do
                        ...
                        if v417.Name == 'Cake Queen [Lv. 2175] [Boss]' and 0 < v417.Humanoid.Health then
                            repeat
                                wait()
...
if Third_Sea then
    _Here3:NewToggle('Auto Rainbow Haki Quest', '', function(p422)
...
_Here3:NewDropdown('SelectBoss', '', tableBoss, function(p443)
    _G.SelectBoss = p443
end)
_Here3:NewToggle('Kill Selected Boss', '', function(p444)
    _G.AutoBoss = p444
end)
spawn(function()
    while wait() do
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild(_G.SelectBoss) then
                    ...
                    while true do
                        ...
                        if v448.Name == _G.SelectBoss and v448:FindFirstChild('Humanoid') and (v448:FindFirstChild('HumanoidRootPart') and 0 < v448.Humanoid.Health) then
                            repeat
                                task.wait()
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                            until not (_G.AutoBoss and v448.Parent) or v448.Humanoid.Health <= 0
                        end
                        ...
                        if v452.Name == _G.SelectBoss then
                            if v452:FindFirstChild('Humanoid') and v452:FindFirstChild('HumanoidRootPart') and v452.Humanoid.Health > 0 then
                                repeat
                                    ...
                                    BringMobs = false
                                until not (_G.AutoBoss and v452.Parent) or v452.Humanoid.Health <= 0
                            end
...
_Here3:NewLabel('Mastery')
_Here3:NewDropdown('Farm Mode', '', {
    'Level',
    'Near Mobs',
}, function(p453)
    TypeMastery = p453
end)
_Here3:NewToggle('Auto BF Mastery', '', function(p454)
    AutoFarmMasDevilFruit = p454
end)
_Here3:NewToggle('Auto Gun Mastery', '', function(p455)
    AutoFarmMasGun = p455
end)
_Here3:NewSlider('Health %', 'Health for mastery', 100, 0, function(p456)
    KillPercent = p456
end)
spawn(function()
    while task.wait(0.1) do
        ...
        elseif AutoFarmMasGun and TypeMastery == 'No Quest' then
            pcall(function()
                ...
                if v464.Name ~= Ms or not v464:FindFirstChild('Humanoid') or not v464:FindFirstChild('HumanoidRootPart') then
                else
                end
                if true then
                    game:GetService('RunService').Heartbeat:wait()
            ...
            if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false then
                if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    pcall(function()
                        ...
                        if v472.Name ~= selectBoss or not v472:FindFirstChild('Humanoid') or not v472:FindFirstChild('HumanoidRootPart') then
                        end
                        if true then
                            game:GetService('RunService').Heartbeat:wait()
    ...
    while task.wait(1) do
        if _G.UseSkill then
            pcall(function()
                ...
                Tween(v488.HumanoidRootPart.CFrame * CFrame.new(u216, u217, u218))

                PositionSkillMasteryDevilFruit = v488.HumanoidRootPart.Position
                ...
                if AutoFarmMasDevilFruit and _G.UseSkill and v488.Humanoid.Health ~= 0 then
                end
                ...
                if v488.Name ~= MonFarm or not v488:FindFirstChild('Humanoid') or (not v488:FindFirstChild('HumanoidRootPart') or v488.Humanoid.Health > v488.Humanoid.MaxHealth * KillPercent / 100) then
                else
                end
            end)
        end
    ...
    while task.wait(0.1) do
        ...
        elseif AutoFarmMasDevilFruit and TypeMastery == 'No Quest' then
            pcall(function()
                ...
                if v496.Name ~= Ms or not v496:FindFirstChild('Humanoid') or not v496:FindFirstChild('HumanoidRootPart') then
                else
                end
            end)
            ...
            if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false then
                if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    pcall(function()
                        ...
                        if v504.Name ~= selectBoss or not v504:FindFirstChild('Humanoid') or not v504:FindFirstChild('HumanoidRootPart') then
                        end
                        if true then
                            game:GetService('RunService').Heartbeat:wait()
...
local _Here4 = _Elite Hub:NewTab('Teleport...'):NewSection('Here')

_Here4:NewButton('First Sea', '', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('TravelMain')
end)
_Here4:NewButton('Second Sea', '', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('TravelDressrosa')
end)
_Here4:NewButton('Third Sea', '', function()
...
_Here4:NewDropdown('SelectIsland', '', IslandList, function(p506)
    _G.SelectIsland = p506
end)
_Here4:NewToggle('TeleportToIsland', '', function(p507)
...
local _here = _Elite Hub:NewTab('Stats...'):NewSection('here')

_here:NewToggle('Auto Melee Stats', '', function(p510)
    _G.Auto_Stats_Melee = p510
end)
_here:NewToggle('Auto Defense Stats', '', function(p511)
    _G.Auto_Stats_Defense = p511
end)
_here:NewToggle('Auto Sword Stats', '', function(p512)
    _G.Auto_Stats_Sword = p512
end)
_here:NewToggle('Auto Gun Stats', '', function(p513)
    _G.Auto_Stats_Gun = p513
end)
_here:NewToggle('Auto Fruit Stats', '', function(p514)
...
local _Here5 = _Elite Hub:NewTab('Misc...'):NewSection('Here')

_Here5:NewToggle('Walk On Water (Recommend)', 'if you using autofarm turn on Walk on water.', function(p516)
...
_Here5:NewToggle('Anti AFK', '', function(p518)
...
_Here5:NewLabel('BackToElite Hub')
_Here5:NewButton('Go back to Elite Hub Universal?', '', function()
    print(loadstring(game:HttpGet('https://raw.githubusercontent.com/KevinGithubUsers/KevinGithubUsers/main/Elite Hub', true))())
end)

local _here2 = _Elite Hub:NewTab('Player...'):NewSection('here')
...
_here2:NewDropdown('SelectPlayer', '', u523, function(p525)
    _G.SelectPly = p525
end)
_here2:NewButton('Refresh Dropdown', 'Refresh player list', function()
    u523 = {}
...
_here2:NewToggle('Teleport To Player', '', function(p530)
    _G.TeleportPly = p530
...
_here2:NewToggle('Spectate Player', '', function(p531)
    SpectatePlys = p531
...
local _here3 = _Elite Hub:NewTab('RaceV4...'):NewSection('here')

if First_Sea then
    _here3:NewLabel('Need to go Sea 3!')
elseif Second_Sea then
    _here3:NewLabel('Need to go Sea 3!')
elseif Third_Sea then
    _here3:NewToggle('FullMoon Notification', '', function(p533)
        _G.Notif = p533
    end)
    spawn(function()
        pcall(function()
    ...
    _here3:NewButton('TweenToTempleOftime', '', function()
        game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    end)
    _here3:NewButton('Lever Pull', '', function()
        TP2(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
    end)
    _here3:NewButton('Ancient One', '', function()
        TP2(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
    end)
    _here3:NewLabel('RaceV4(Beta)')
    _here3:NewButton('Race Door', '', function()
        Game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    ...
    _here3:NewToggle('Auto [ Human / Ghoul ] Trial', '', function(p534)
        KillAura = p534
    end)
    _here3:NewToggle('Auto Trial', '', function(p535)
                                            ...
                                            if u543:FindFirstChild('Humanoid') and u543:FindFirstChild('HumanoidRootPart') and u543.Humanoid.Health > 0 then
                                                pcall(function()
                                                    repeat
                                                        ...
                                                        sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                                    until not (_G.AutoQuestRace and u543.Parent) or u543.Humanoid.Health <= 0
                                                end)
                                            end
                                        end
                                    end
                            ...
                            if u571:FindFirstChild('Humanoid') and u571:FindFirstChild('HumanoidRootPart') and u571.Humanoid.Health > 0 then
                                pcall(function()
                                    repeat
                                        ...
                                        sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                    until not (_G.AutoQuestRace and u571.Parent) or u571.Humanoid.Health <= 0
                                end)
                            end
                        end
                    end
    ...
    _here3:NewLabel('Misc RaceV4')
    _here3:NewToggle('Auto Ancient Quest', '', function(p572)
        AutoFarmAcient = p572
    end)
                        ...
                        while true do
                            ...
                            if (v577.Name == 'Cocoa Warrior' or v577.Name == 'Chocolate Bar Battler' or (v577.Name == 'Sweet Thief' or v577.Name == 'Candy Rebel')) and (v577:FindFirstChild('Humanoid') and v577:FindFirstChild('HumanoidRootPart') and v577.Humanoid.Health > 0) then
                                repeat
                                    ...
                                    Click()
                                until not (AutoFarmAcient and v577.Parent) or v577.Humanoid.Health <= 0
...
local _here4 = _Elite Hub:NewTab('Shop...'):NewSection('here')

_here4:NewLabel('Shop')
_here4:NewButton('Refund Stats', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BlackbeardReward', 'Refund', '1')
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BlackbeardReward', 'Refund', '2')
end)
_here4:NewButton('Reroll Race', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BlackbeardReward', 'Reroll', '1')
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BlackbeardReward', 'Reroll', '2')
end)
_here4:NewLabel('Fighting Styles')
_here4:NewButton('Black Leg', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuyBlackLeg')
end)
_here4:NewButton('Electro', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuyElectro')
end)
_here4:NewButton('Fishman Karate', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuyFishmanKarate')
end)
_here4:NewButton('Dragon Claw', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BlackbeardReward', 'DragonClaw', '1')
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BlackbeardReward', 'DragonClaw', '2')
end)
_here4:NewButton('Superhuman', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuySuperhuman')
end)
_here4:NewButton('Death Step', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuyDeathStep')
end)
_here4:NewButton('Sharkman Karate', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuySharkmanKarate', true)
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuySharkmanKarate')
end)
_here4:NewButton('Electric Claw', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuyElectricClaw')
end)
_here4:NewButton('Dragon Talon', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuyDragonTalon')
end)
_here4:NewButton('Godhuman', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuyGodhuman')
end)
_here4:NewButton('SanguineArt', '?', function()
    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('BuySanguineArt')
end)

if Third_Sea then
    local _here5 = _Elite Hub:NewTab('Sea...'):NewSection('here')

    _here5:NewToggle('Auto Buy Boat', '', function(p584)
        _G.AutoBuyBoat = p584
    end)
    task.spawn(function()
        while wait() do
    ...
    _here5:NewToggle('Auto Press W', '', function(p597)
        _G.AutoW = p597
    end)
    spawn(function()
        while wait() do
    ...
    _here5:NewToggle('Auto Kill Terrorshark', '', function(p598)
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Terrorshark') then
                        ...
                        while true do
                            ...
                            if v602.Name == 'Terrorshark' and v602:FindFirstChild('Humanoid') and (v602:FindFirstChild('HumanoidRootPart') and 0 < v602.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                ...
                                until not (_G.AutoTerrorshark and v602.Parent) or v602.Humanoid.Health <= 0
                            end
                        end
    ...
    _here5:NewToggle('Auto Kill Piranha', '', function(p603)
        _G.farmpiranya = p603
    end)
    spawn(function()
        while wait() do
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Piranha') then
                        ...
                        while true do
                            ...
                            if v607.Name == 'Piranha' and v607:FindFirstChild('Humanoid') and (v607:FindFirstChild('HumanoidRootPart') and 0 < v607.Humanoid.Health) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                ...
                                until not (_G.farmpiranya and v607.Parent) or v607.Humanoid.Health <= 0
                            end
                        end
    ...
    _here5:NewToggle('Auto Sea Beast', '', function(p608)
...
_Elite Hub:NewTab('?'):NewSection('here')
