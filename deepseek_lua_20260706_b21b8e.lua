-- // ELITE HUB v1.0.0 | WINDUITWIN EDITION 🥀
...
-- // WAIT FOR USER TO CLOSE DISCORD NOTIFICATION
...
local Window = WindUI:CreateWindow({
    Title = 'ELITE HUB (JAILBREAK) - FUCK SHIT UP 🥀',
    Size = {580, 460},
    Theme = 'Dark',
})

local Tabs = {
    Main = Window:AddTab({ Title = 'MAIN (FUCK SHIT UP)' }),
    ESP = Window:AddTab({ Title = 'ESP (SEE BITCHES)' }),
    Misc = Window:AddTab({ Title = 'MISC (EXTRA SHIT)' }),
    Robberies = Window:AddTab({ Title = 'ROBBERIES (STEAL THAT SHIT)' }),
}
...
Tabs.Main:AddParagraph({ 
    Title = 'GIVE ITEMS', 
    Content = 'Pistol, Baton, Shotgun and SWAT stuff - FUCK YEAH' 
})
...
-- // ESP TOGGLES (WINDUITWIN STYLE)
local espToggle = Tabs.ESP:AddToggle({
    Title = 'ESP (WALLHACK BITCH)',
    Default = false,
    Callback = function(v)
        espEnabled = v
...
local tracersToggle = Tabs.ESP:AddToggle({
    Title = 'TRACERS (FOLLOW THAT BITCH)',
    Default = false,
    Callback = function(v) 
        tracersEnabled = v
...
local boxesToggle = Tabs.ESP:AddToggle({
    Title = 'BOXES (CAGE THAT BITCH)',
    Default = false,
    Callback = function(v)
        boxesEnabled = v
        if espEnabled then clearESP() end
...
local namesToggle = Tabs.ESP:AddToggle({
    Title = 'NAMES (WHO THAT BITCH)',
    Default = false,
    Callback = function(v)
        namesEnabled = v
        if espEnabled then clearESP() end
...
local distanceToggle = Tabs.ESP:AddToggle({
    Title = 'DISTANCE (HOW FAR BITCH)',
    Default = false,
    Callback = function(v)
        distanceEnabled = v
        if espEnabled then clearESP() end
...
local spikeStorage = {}
Robberies:AddToggle({
    Title = 'REMOVE SPIKES (NO MORE PAIN)',
    Default = false,
    Callback = function(v)
...
local dartStorage = {}
Robberies:AddToggle({
    Title = 'REMOVE DARTS (FUCK THOSE NEEDLES)',
    Default = false,
    Callback = function(v)
...
Robberies:AddToggle({
    Title = 'REMOVE PLANKS (NO MORE WALKING)',
    Default = false,
    Callback = function(v)
...
Robberies:AddToggle({
    Title = 'REMOVE LAVA DAMAGE (NO MORE BURNING)',
    Default = false,
    Callback = function(v)
...
Robberies:AddSection('POWER PLANT (FUCK LASERS)')
local powerLasers = {}
...
Robberies:AddToggle({
    Title = 'REMOVE LASERS (NO MORE ZAPPING)',
    Default = false,
    Callback = function(v)
        if v then
...
Robberies:AddSection('CARGO SHIP (REMOVE TURRETS)')
local cargoTurrets = {}
Robberies:AddToggle({
    Title = 'REMOVE CARGO SHIP TURRETS',
    Default = false,
    Callback = function(v)
...
Tabs.Misc:AddToggle({
    Title = 'INFINITE JUMP (JUMP FOREVER BITCH)',
    Default = false,
    Callback = function(v)
...
Tabs.Misc:AddToggle({
    Title = 'CLICK TP (TELEPORT ON CLICK)',
    Default = false,
    Callback = function(v)
        clickTPEnabled = v
    end
...
print("████████████████████████████████████████████████████████████")
print("ELITE HUB v1.0.0 - WINDUITWIN EDITION - GO FUCK SHIT UP")
