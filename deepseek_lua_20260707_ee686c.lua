-- // ========== ELITE HUB v1.0.0 | COMPLETE (NO API) ==========
...
local memberCount = "9,175"  -- No API, just hardcoded
...
local fadeTween = TweenService:Create(loadingGui, TweenInfo.new(0.4), {BackgroundTransparency = 1})
fadeTween:Play()
