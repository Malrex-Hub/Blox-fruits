...
local function applyTheme(themeName)
    ...
    pcall(function()
        if Window and Window.Frame then
            ...
            if header then header.BackgroundColor3 = theme.Header end
...
-- // DESTROY LOADING SCREEN THEN LOAD RAYFIELD
...
fadeTween.Completed:Connect(function()
    ...
    -- // WAIT A TICK THEN LOAD RAYFIELD
    task.wait(0.1)
    loadMain()
end)
...
-- // ========== MAIN FUNCTION ==========
function loadMain()
    -- // Load Rayfield with pcall for safety
