-- // ========== ELITE HUB v1.0.0 | MARCUS EDITION ==========
-- // discord.gg/5RuMCxK3u6
-- // MADE BY MARCUS - FUCK YOU IF YOU STEAL THIS SHIT - 9,175 MEMBERS 🥀
...
local Themes = {
    ...
    ["Marcus Purple"] = {
        shade1 = Color3.fromRGB(20, 10, 30),
        shade2 = Color3.fromRGB(40, 20, 60),
        shade3 = Color3.fromRGB(80, 40, 120),
        text1 = Color3.fromRGB(200, 150, 255),
        text2 = Color3.fromRGB(150, 0, 255),
        scroll = Color3.fromRGB(80, 40, 120),
        accent = Color3.fromRGB(150, 0, 255)
    },
    ["Blood Red"] = {
        shade1 = Color3.fromRGB(40, 10, 10),
        shade2 = Color3.fromRGB(60, 15, 15),
        shade3 = Color3.fromRGB(100, 25, 25),
        text1 = Color3.fromRGB(255, 200, 200),
        text2 = Color3.fromRGB(255, 0, 0),
        scroll = Color3.fromRGB(100, 25, 25),
        accent = Color3.fromRGB(255, 0, 0)
    },
    ["Neon Blue"] = {
        shade1 = Color3.fromRGB(10, 10, 40),
        shade2 = Color3.fromRGB(15, 15, 60),
        shade3 = Color3.fromRGB(25, 25, 100),
        text1 = Color3.fromRGB(150, 200, 255),
        text2 = Color3.fromRGB(0, 100, 255),
        scroll = Color3.fromRGB(25, 25, 100),
        accent = Color3.fromRGB(0, 150, 255)
    },
    ["Purple Haze"] = {
        shade1 = Color3.fromRGB(30, 10, 40),
        shade2 = Color3.fromRGB(45, 15, 60),
        shade3 = Color3.fromRGB(75, 25, 100),
        text1 = Color3.fromRGB(200, 150, 255),
        text2 = Color3.fromRGB(150, 0, 255),
        scroll = Color3.fromRGB(75, 25, 100),
        accent = Color3.fromRGB(150, 0, 255)
    },
    ["Matrix Green"] = {
        shade1 = Color3.fromRGB(10, 30, 10),
        shade2 = Color3.fromRGB(15, 45, 15),
        shade3 = Color3.fromRGB(25, 75, 25),
        text1 = Color3.fromRGB(100, 255, 100),
        text2 = Color3.fromRGB(0, 255, 0),
        scroll = Color3.fromRGB(25, 75, 25),
        accent = Color3.fromRGB(0, 255, 0)
    },
    ["Gold"] = {
        shade1 = Color3.fromRGB(40, 35, 10),
        shade2 = Color3.fromRGB(60, 50, 15),
        shade3 = Color3.fromRGB(100, 85, 25),
        text1 = Color3.fromRGB(255, 215, 100),
        text2 = Color3.fromRGB(255, 200, 0),
        scroll = Color3.fromRGB(100, 85, 25),
        accent = Color3.fromRGB(255, 200, 0)
    },
    ["Cotton Candy"] = {
        shade1 = Color3.fromRGB(40, 20, 40),
        shade2 = Color3.fromRGB(60, 30, 60),
        shade3 = Color3.fromRGB(100, 50, 100),
        text1 = Color3.fromRGB(255, 150, 255),
        text2 = Color3.fromRGB(255, 100, 255),
        scroll = Color3.fromRGB(100, 50, 100),
        accent = Color3.fromRGB(255, 100, 255)
    },
    ["Ocean"] = {
        shade1 = Color3.fromRGB(10, 20, 40),
        shade2 = Color3.fromRGB(15, 30, 60),
        shade3 = Color3.fromRGB(25, 50, 100),
        text1 = Color3.fromRGB(100, 200, 255),
        text2 = Color3.fromRGB(0, 100, 200),
        scroll = Color3.fromRGB(25, 50, 100),
        accent = Color3.fromRGB(0, 150, 255)
    },
    ["Sunset"] = {
        shade1 = Color3.fromRGB(40, 20, 10),
        shade2 = Color3.fromRGB(60, 30, 15),
        shade3 = Color3.fromRGB(100, 50, 25),
        text1 = Color3.fromRGB(255, 200, 150),
        text2 = Color3.fromRGB(255, 150, 50),
        scroll = Color3.fromRGB(100, 50, 25),
...
subtitleText.Text = "MARCUS EDITION 🥀"
...
local steps = {
    ...
    { text = "🔥 MARCUS EDITION READY 🥀", progress = 100 }
}
...
function loadMain()
    ...
    local Window = Rayfield:CreateWindow({
        Name = "ELITE HUB | MARCUS EDITION 🥀",
        Icon = 0,
        LoadingTitle = "ELITE HUB",
        LoadingSubtitle = "MARCUS EDITION",
        Theme = "Dark",
        ConfigurationSaving = {
            Enabled = true,
            FolderName = "EliteHub",
    ...
    local function applyTheme(themeName)
        ...
        pcall(function()
            if loadingCard then
                loadingCard.BackgroundColor3 = theme.shade1
            end
            if glowBorder then
    ...
    local function updateDiscordPresence()
        pcall(function()
            local discord = syn and syn.discord
            if discord then
                discord:setPresence({
                    state = "Fucking shit up in Jailbreak",
                    details = "Elite Hub - Marcus Edition v1.0.0",
                    largeImageKey = "jailbreak",
                    largeImageText = "Jailbreak",
                    smallImageKey = "elite",
                    smallImageText = memberCount .. " Members 🥀",
                    buttons = {
                        {label = "Join Discord", url = "https://discord.gg/5RuMCxK3u6"},
                        {label = "Made by Marcus", url = "https://github.com/marcus"}
                    }
                })
            end
        end)
    end
    task.spawn(updateDiscordPresence)
    task.spawn(function()
        while true do
            task.wait(30)
    ...
    local function startSpoofSpeed()
        local realSpeed = speedValue
    ...
    local function startHybridSpeed()
    ...
    SpeedTab:CreateDropdown({
        ...
        Callback = function(v)
            if v == "Loop Speed (Basic)" then
                speedMethod = 1
            elseif v == "Spoof Speed (Bypass)" then
                speedMethod = 2
            elseif v == "TP Walk (Bypass)" then
                speedMethod = 3
            elseif v == "Velocity Speed (Best Bypass)" then
                speedMethod = 4
            elseif v == "CFrame Speed (Ultimate Bypass)" then
                speedMethod = 5
            elseif v == "Hybrid Speed (Mega Bypass)" then
                speedMethod = 6
            end
            if speedEnabled then
                stopSpeed()
    ...
    StarterGui:SetCore("SendNotification", {
        ...
        Text = "LOADED YOU FUCKING BITCH - MARCUS EDITION - " .. memberCount .. " MEMBERS 🥀",
        Duration = 3
    })
    
    print("████████████████████████████████████████████████████████████")
    print("ELITE HUB v1.0.0 - MARCUS EDITION - " .. memberCount .. " MEMBERS 🥀")
