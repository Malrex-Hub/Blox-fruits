...
local Themes = {
    ...
    ["Dark Purple"] = {
        ...
        NotificationBackground = Color3.fromRGB(35, 25, 50),
        NotificationActionsBackground = Color3.fromRGB(150, 100, 255),
        TabBackground = Color3.fromRGB(60, 40, 90),
        TabStroke = Color3.fromRGB(80, 55, 120),
        TabBackgroundSelected = Color3.fromRGB(150, 100, 255),
        TabTextColor = Color3.fromRGB(200, 180, 255),
        SelectedTabTextColor = Color3.fromRGB(255, 255, 255),
        ElementBackground = Color3.fromRGB(30, 20, 45),
        ElementBackgroundHover = Color3.fromRGB(45, 30, 65),
        SecondaryElementBackground = Color3.fromRGB(22, 15, 35),
        ElementStroke = Color3.fromRGB(80, 55, 120),
        SecondaryElementStroke = Color3.fromRGB(60, 40, 90),
        SliderBackground = Color3.fromRGB(150, 100, 255),
        SliderProgress = Color3.fromRGB(150, 100, 255),
        SliderStroke = Color3.fromRGB(180, 130, 255),
        ToggleBackground = Color3.fromRGB(28, 18, 42),
        ToggleEnabled = Color3.fromRGB(150, 100, 255),
        ToggleDisabled = Color3.fromRGB(80, 55, 100),
        ToggleEnabledStroke = Color3.fromRGB(180, 130, 255),
        ToggleDisabledStroke = Color3.fromRGB(100, 75, 120),
        ToggleEnabledOuterStroke = Color3.fromRGB(120, 70, 200),
        ToggleDisabledOuterStroke = Color3.fromRGB(60, 40, 80),
        DropdownSelected = Color3.fromRGB(60, 40, 90),
        DropdownUnselected = Color3.fromRGB(30, 20, 45),
        InputBackground = Color3.fromRGB(28, 18, 42),
        InputStroke = Color3.fromRGB(80, 55, 120),
        PlaceholderColor = Color3.fromRGB(160, 130, 220)
    },
    ["Dark Blue"] = {
        TextColor = Color3.fromRGB(180, 200, 255),
        Background = Color3.fromRGB(10, 15, 30),
        Topbar = Color3.fromRGB(20, 30, 55),
        Shadow = Color3.fromRGB(8, 12, 25),
        NotificationBackground = Color3.fromRGB(20, 30, 55),
        NotificationActionsBackground = Color3.fromRGB(50, 120, 255),
        TabBackground = Color3.fromRGB(40, 60, 100),
        TabStroke = Color3.fromRGB(55, 80, 130),
        TabBackgroundSelected = Color3.fromRGB(50, 120, 255),
        TabTextColor = Color3.fromRGB(180, 200, 255),
        SelectedTabTextColor = Color3.fromRGB(255, 255, 255),
        ElementBackground = Color3.fromRGB(18, 25, 45),
        ElementBackgroundHover = Color3.fromRGB(30, 40, 65),
        SecondaryElementBackground = Color3.fromRGB(12, 18, 35),
        ElementStroke = Color3.fromRGB(55, 80, 130),
        SecondaryElementStroke = Color3.fromRGB(40, 60, 100),
        SliderBackground = Color3.fromRGB(50, 120, 255),
        SliderProgress = Color3.fromRGB(50, 120, 255),
        SliderStroke = Color3.fromRGB(80, 150, 255),
        ToggleBackground = Color3.fromRGB(15, 22, 42),
        ToggleEnabled = Color3.fromRGB(50, 120, 255),
        ToggleDisabled = Color3.fromRGB(60, 80, 120),
        ToggleEnabledStroke = Color3.fromRGB(80, 150, 255),
        ToggleDisabledStroke = Color3.fromRGB(80, 100, 140),
        ToggleEnabledOuterStroke = Color3.fromRGB(40, 90, 200),
        ToggleDisabledOuterStroke = Color3.fromRGB(40, 55, 85),
        DropdownSelected = Color3.fromRGB(40, 60, 100),
        DropdownUnselected = Color3.fromRGB(18, 25, 45),
        InputBackground = Color3.fromRGB(15, 22, 42),
        InputStroke = Color3.fromRGB(55, 80, 130),
        PlaceholderColor = Color3.fromRGB(130, 160, 220)
    },
    ["Dark Red"] = {
        TextColor = Color3.fromRGB(255, 200, 200),
        Background = Color3.fromRGB(30, 10, 10),
        Topbar = Color3.fromRGB(55, 18, 18),
        Shadow = Color3.fromRGB(22, 8, 8),
        NotificationBackground = Color3.fromRGB(55, 18, 18),
        NotificationActionsBackground = Color3.fromRGB(220, 50, 50),
        TabBackground = Color3.fromRGB(90, 30, 30),
        TabStroke = Color3.fromRGB(130, 45, 45),
        TabBackgroundSelected = Color3.fromRGB(220, 50, 50),
        TabTextColor = Color3.fromRGB(255, 200, 200),
        SelectedTabTextColor = Color3.fromRGB(255, 255, 255),
        ElementBackground = Color3.fromRGB(45, 15, 15),
        ElementBackgroundHover = Color3.fromRGB(65, 22, 22),
        SecondaryElementBackground = Color3.fromRGB(35, 10, 10),
        ElementStroke = Color3.fromRGB(130, 45, 45),
        SecondaryElementStroke = Color3.fromRGB(90, 30, 30),
        SliderBackground = Color3.fromRGB(220, 50, 50),
        SliderProgress = Color3.fromRGB(220, 50, 50),
        SliderStroke = Color3.fromRGB(255, 80, 80),
        ToggleBackground = Color3.fromRGB(40, 12, 12),
        ToggleEnabled = Color3.fromRGB(220, 50, 50),
        ToggleDisabled = Color3.fromRGB(110, 40, 40),
        ToggleEnabledStroke = Color3.fromRGB(255, 80, 80),
        ToggleDisabledStroke = Color3.fromRGB(140, 55, 55),
        ...
        InputBackground = Color3.fromRGB(40, 12, 12),
        InputStroke = Color3.fromRGB(130, 45, 45),
        PlaceholderColor = Color3.fromRGB(210, 130, 130)
    },
    ["Dark Green"] = {
        TextColor = Color3.fromRGB(180, 255, 180),
        Background = Color3.fromRGB(10, 30, 10),
        Topbar = Color3.fromRGB(18, 55, 18),
        Shadow = Color3.fromRGB(8, 22, 8),
        NotificationBackground = Color3.fromRGB(18, 55, 18),
        NotificationActionsBackground = Color3.fromRGB(50, 220, 50),
        TabBackground = Color3.fromRGB(30, 90, 30),
        TabStroke = Color3.fromRGB(45, 130, 45),
        TabBackgroundSelected = Color3.fromRGB(50, 220, 50),
        TabTextColor = Color3.fromRGB(180, 255, 180),
        SelectedTabTextColor = Color3.fromRGB(0, 0, 0),
        ElementBackground = Color3.fromRGB(15, 45, 15),
        ElementBackgroundHover = Color3.fromRGB(22, 65, 22),
        SecondaryElementBackground = Color3.fromRGB(10, 35, 10),
        ElementStroke = Color3.fromRGB(45, 130, 45),
        SecondaryElementStroke = Color3.fromRGB(30, 90, 30),
        SliderBackground = Color3.fromRGB(50, 220, 50),
        SliderProgress = Color3.fromRGB(50, 220, 50),
        SliderStroke = Color3.fromRGB(80, 255, 80),
        ToggleBackground = Color3.fromRGB(12, 40, 12),
        ToggleEnabled = Color3.fromRGB(50, 220, 50),
        ToggleDisabled = Color3.fromRGB(40, 110, 40),
        ToggleEnabledStroke = Color3.fromRGB(80, 255, 80),
        ToggleDisabledStroke = Color3.fromRGB(55, 140, 55),
        ToggleEnabledOuterStroke = Color3.fromRGB(30, 180, 30),
        ToggleDisabledOuterStroke = Color3.fromRGB(25, 80, 25),
        DropdownSelected = Color3.fromRGB(30, 90, 30),
        DropdownUnselected = Color3.fromRGB(15, 45, 15),
        InputBackground = Color3.fromRGB(12, 40, 12),
        InputStroke = Color3.fromRGB(45, 130, 45),
        PlaceholderColor = Color3.fromRGB(130, 210, 130)
    },
    ["Dark Orange"] = {
        TextColor = Color3.fromRGB(255, 215, 180),
        Background = Color3.fromRGB(30, 20, 10),
        Topbar = Color3.fromRGB(55, 35, 18),
        Shadow = Color3.fromRGB(22, 15, 8),
        NotificationBackground = Color3.fromRGB(55, 35, 18),
        NotificationActionsBackground = Color3.fromRGB(255, 150, 50),
        TabBackground = Color3.fromRGB(90, 55, 30),
        TabStroke = Color3.fromRGB(130, 80, 45),
        TabBackgroundSelected = Color3.fromRGB(255, 150, 50),
        TabTextColor = Color3.fromRGB(255, 215, 180),
        SelectedTabTextColor = Color3.fromRGB(0, 0, 0),
        ElementBackground = Color3.fromRGB(45, 28, 15),
        ElementBackgroundHover = Color3.fromRGB(65, 40, 22),
        SecondaryElementBackground = Color3.fromRGB(35, 20, 10),
        ElementStroke = Color3.fromRGB(130, 80, 45),
        SecondaryElementStroke = Color3.fromRGB(90, 55, 30),
        SliderBackground = Color3.fromRGB(255, 150, 50),
        SliderProgress = Color3.fromRGB(255, 150, 50),
        SliderStroke = Color3.fromRGB(255, 180, 80),
        ToggleBackground = Color3.fromRGB(40, 25, 12),
        ToggleEnabled = Color3.fromRGB(255, 150, 50),
        ToggleDisabled = Color3.fromRGB(110, 70, 40),
        ToggleEnabledStroke = Color3.fromRGB(255, 180, 80),
        ToggleDisabledStroke = Color3.fromRGB(140, 90, 55),
        ToggleEnabledOuterStroke = Color3.fromRGB(200, 110, 30),
        ToggleDisabledOuterStroke = Color3.fromRGB(80, 50, 25),
        DropdownSelected = Color3.fromRGB(90, 55, 30),
        DropdownUnselected = Color3.fromRGB(45, 28, 15),
        InputBackground = Color3.fromRGB(40, 25, 12),
        InputStroke = Color3.fromRGB(130, 80, 45),
        PlaceholderColor = Color3.fromRGB(210, 170, 130)
    },
    ["Neon Blue"] = {
    ...
    ["Neon Green"] = {
        ...
        Background = Color3.fromRGB(8, 35, 8),
        Topbar = Color3.fromRGB(12, 55, 12),
        Shadow = Color3.fromRGB(5, 25, 5),
        NotificationBackground = Color3.fromRGB(12, 55, 12),
        NotificationActionsBackground = Color3.fromRGB(0, 255, 100),
        TabBackground = Color3.fromRGB(20, 80, 20),
        TabStroke = Color3.fromRGB(30, 120, 30),
        TabBackgroundSelected = Color3.fromRGB(0, 255, 100),
        TabTextColor = Color3.fromRGB(150, 255, 150),
        SelectedTabTextColor = Color3.fromRGB(0, 0, 0),
        ElementBackground = Color3.fromRGB(15, 50, 15),
        ElementBackgroundHover = Color3.fromRGB(25, 75, 25),
        SecondaryElementBackground = Color3.fromRGB(10, 40, 10),
        ElementStroke = Color3.fromRGB(30, 120, 30),
        SecondaryElementStroke = Color3.fromRGB(20, 80, 20),
        SliderBackground = Color3.fromRGB(0, 255, 100),
        SliderProgress = Color3.fromRGB(0, 255, 100),
        SliderStroke = Color3.fromRGB(50, 255, 150),
        ToggleBackground = Color3.fromRGB(12, 50, 12),
        ToggleEnabled = Color3.fromRGB(0, 255, 100),
        ToggleDisabled = Color3.fromRGB(40, 100, 40),
        ToggleEnabledStroke = Color3.fromRGB(50, 255, 150),
        ToggleDisabledStroke = Color3.fromRGB(60, 130, 60),
        ToggleEnabledOuterStroke = Color3.fromRGB(0, 200, 80),
        ToggleDisabledOuterStroke = Color3.fromRGB(30, 80, 30),
        DropdownSelected = Color3.fromRGB(20, 80, 20),
        DropdownUnselected = Color3.fromRGB(15, 50, 15),
        InputBackground = Color3.fromRGB(12, 50, 12),
        InputStroke = Color3.fromRGB(30, 120, 30),
        PlaceholderColor = Color3.fromRGB(130, 220, 130)
    },
    ["Neon Pink"] = {
        TextColor = Color3.fromRGB(255, 150, 200),
        Background = Color3.fromRGB(35, 8, 25),
        Topbar = Color3.fromRGB(55, 12, 40),
        Shadow = Color3.fromRGB(25, 5, 18),
        NotificationBackground = Color3.fromRGB(55, 12, 40),
        NotificationActionsBackground = Color3.fromRGB(255, 50, 150),
        TabBackground = Color3.fromRGB(80, 20, 60),
        TabStroke = Color3.fromRGB(120, 30, 90),
        TabBackgroundSelected = Color3.fromRGB(255, 50, 150),
        TabTextColor = Color3.fromRGB(255, 150, 200),
        SelectedTabTextColor = Color3.fromRGB(255, 255, 255),
        ElementBackground = Color3.fromRGB(50, 15, 38),
        ElementBackgroundHover = Color3.fromRGB(75, 22, 55),
        SecondaryElementBackground = Color3.fromRGB(40, 10, 30),
        ElementStroke = Color3.fromRGB(120, 30, 90),
        SecondaryElementStroke = Color3.fromRGB(80, 20, 60),
        SliderBackground = Color3.fromRGB(255, 50, 150),
        SliderProgress = Color3.fromRGB(255, 50, 150),
        SliderStroke = Color3.fromRGB(255, 80, 180),
        ToggleBackground = Color3.fromRGB(45, 12, 35),
        ToggleEnabled = Color3.fromRGB(255, 50, 150),
        ToggleDisabled = Color3.fromRGB(100, 40, 80),
        ToggleEnabledStroke = Color3.fromRGB(255, 80, 180),
        ToggleDisabledStroke = Color3.fromRGB(130, 55, 100),
        ToggleEnabledOuterStroke = Color3.fromRGB(200, 30, 120),
        ToggleDisabledOuterStroke = Color3.fromRGB(70, 25, 55),
        DropdownSelected = Color3.fromRGB(80, 20, 60),
        DropdownUnselected = Color3.fromRGB(50, 15, 38),
        InputBackground = Color3.fromRGB(45, 12, 35),
        InputStroke = Color3.fromRGB(120, 30, 90),
        PlaceholderColor = Color3.fromRGB(220, 130, 180)
    },
    ["Neon Purple"] = {
        TextColor = Color3.fromRGB(200, 150, 255),
        Background = Color3.fromRGB(20, 8, 35),
        Topbar = Color3.fromRGB(35, 12, 55),
        Shadow = Color3.fromRGB(15, 5, 25),
        NotificationBackground = Color3.fromRGB(35, 12, 55),
        NotificationActionsBackground = Color3.fromRGB(150, 50, 255),
        TabBackground = Color3.fromRGB(55, 20, 85),
        TabStroke = Color3.fromRGB(80, 30, 120),
        TabBackgroundSelected = Color3.fromRGB(150, 50, 255),
        TabTextColor = Color3.fromRGB(200, 150, 255),
        SelectedTabTextColor = Color3.fromRGB(255, 255, 255),
        ElementBackground = Color3.fromRGB(30, 12, 50),
        ElementBackgroundHover = Color3.fromRGB(45, 18, 75),
        SecondaryElementBackground = Color3.fromRGB(22, 8, 40),
        ElementStroke = Color3.fromRGB(80, 30, 120),
        SecondaryElementStroke = Color3.fromRGB(55, 20, 85),
        SliderBackground = Color3.fromRGB(150, 50, 255),
        SliderProgress = Color3.fromRGB(150, 50, 255),
        SliderStroke = Color3.fromRGB(180, 80, 255),
        ToggleBackground = Color3.fromRGB(28, 10, 45),
        ToggleEnabled = Color3.fromRGB(150, 50, 255),
        ToggleDisabled = Color3.fromRGB(80, 30, 100),
        ToggleEnabledStroke = Color3.fromRGB(180, 80, 255),
        ToggleDisabledStroke = Color3.fromRGB(100, 45, 120),
        ToggleEnabledOuterStroke = Color3.fromRGB(120, 30, 200),
        ToggleDisabledOuterStroke = Color3.fromRGB(60, 20, 80),
        DropdownSelected = Color3.fromRGB(55, 20, 85),
        DropdownUnselected = Color3.fromRGB(30, 12, 50),
        InputBackground = Color3.fromRGB(28, 10, 45),
        InputStroke = Color3.fromRGB(80, 30, 120),
        PlaceholderColor = Color3.fromRGB(160, 100, 220)
    },
    ["Neon Yellow"] = {
        TextColor = Color3.fromRGB(255, 255, 150),
        Background = Color3.fromRGB(35, 35, 8),
        Topbar = Color3.fromRGB(55, 55, 12),
        Shadow = Color3.fromRGB(25, 25, 5),
        NotificationBackground = Color3.fromRGB(55, 55, 12),
        NotificationActionsBackground = Color3.fromRGB(255, 255, 50),
        TabBackground = Color3.fromRGB(80, 80, 20),
        TabStroke = Color3.fromRGB(120, 120, 30),
        TabBackgroundSelected = Color3.fromRGB(255, 255, 50),
        TabTextColor = Color3.fromRGB(255, 255, 150),
        SelectedTabTextColor = Color3.fromRGB(0, 0, 0),
        ElementBackground = Color3.fromRGB(50, 50, 15),
        ElementBackgroundHover = Color3.fromRGB(75, 75, 22),
        SecondaryElementBackground = Color3.fromRGB(40, 40, 10),
        ElementStroke = Color3.fromRGB(120, 120, 30),
        SecondaryElementStroke = Color3.fromRGB(80, 80, 20),
        SliderBackground = Color3.fromRGB(255, 255, 50),
        SliderProgress = Color3.fromRGB(255, 255, 50),
        SliderStroke = Color3.fromRGB(255, 255, 80),
        ToggleBackground = Color3.fromRGB(45, 45, 12),
        ToggleEnabled = Color3.fromRGB(255, 255, 50),
        ToggleDisabled = Color3.fromRGB(100, 100, 40),
        ToggleEnabledStroke = Color3.fromRGB(255, 255, 80),
        ToggleDisabledStroke = Color3.fromRGB(130, 130, 55),
        ToggleEnabledOuterStroke = Color3.fromRGB(200, 200, 30),
        ToggleDisabledOuterStroke = Color3.fromRGB(70, 70, 25),
        DropdownSelected = Color3.fromRGB(80, 80, 20),
        DropdownUnselected = Color3.fromRGB(50, 50, 15),
        InputBackground = Color3.fromRGB(45, 45, 12),
        InputStroke = Color3.fromRGB(120, 120, 30),
        PlaceholderColor = Color3.fromRGB(220, 220, 130)
    },
    ["Marcus Purple"] = {
    ...
    ["Candy"] = {
        ...
        Background = Color3.fromRGB(35, 10, 20),
        Topbar = Color3.fromRGB(55, 18, 35),
        Shadow = Color3.fromRGB(25, 8, 15),
        NotificationBackground = Color3.fromRGB(55, 18, 35),
        NotificationActionsBackground = Color3.fromRGB(255, 80, 150),
        TabBackground = Color3.fromRGB(85, 28, 55),
        TabStroke = Color3.fromRGB(120, 40, 80),
        TabBackgroundSelected = Color3.fromRGB(255, 80, 150),
        TabTextColor = Color3.fromRGB(255, 180, 200),
        SelectedTabTextColor = Color3.fromRGB(255, 255, 255),
        ElementBackground = Color3.fromRGB(50, 15, 28),
        ElementBackgroundHover = Color3.fromRGB(75, 22, 42),
        SecondaryElementBackground = Color3.fromRGB(40, 10, 22),
        ElementStroke = Color3.fromRGB(120, 40, 80),
        SecondaryElementStroke = Color3.fromRGB(85, 28, 55),
        SliderBackground = Color3.fromRGB(255, 80, 150),
        SliderProgress = Color3.fromRGB(255, 80, 150),
        SliderStroke = Color3.fromRGB(255, 130, 190),
        ToggleBackground = Color3.fromRGB(45, 12, 25),
        ToggleEnabled = Color3.fromRGB(255, 80, 150),
        ToggleDisabled = Color3.fromRGB(100, 40, 80),
        ToggleEnabledStroke = Color3.fromRGB(255, 130, 190),
        ToggleDisabledStroke = Color3.fromRGB(130, 55, 100),
        ToggleEnabledOuterStroke = Color3.fromRGB(200, 50, 120),
        ToggleDisabledOuterStroke = Color3.fromRGB(70, 28, 55),
        DropdownSelected = Color3.fromRGB(85, 28, 55),
        DropdownUnselected = Color3.fromRGB(50, 15, 28),
        InputBackground = Color3.fromRGB(45, 12, 25),
        InputStroke = Color3.fromRGB(120, 40, 80),
        PlaceholderColor = Color3.fromRGB(220, 130, 170)
    }
}
...
function loadMain()
    ...
    -- // ========== AIMBOT (CONVERTED FROM YOUR SCRIPT) ==========
