--[[
    ELITE HUB - Loader Script v1.0.2
    Made by marcus 🥀
...
local Config = {
    -- Main Settings
    HubName = "ELITE HUB",
    Subtitle = "v1.0.2 | by marcus 🥀",
    LogoLetter = "E",
    LoadTime = 8,

    -- Main script to load after animation
    ScriptToLoad = "", -- Will be set dynamically
    ...
    Tips = {
        ...
        "Elite Hub v1.0.2 - Fully Loaded",
        "Fuck you if you steal this 🥀",
        "Grow a Garden 2? We got that shit!",
        "TSB? We got that too! 🔥"
    },
    ...
    Theme = {
        Primary = Color3.fromRGB(50, 150, 255),      -- Elite Blue
        Secondary = Color3.fromRGB(30, 100, 200),    -- Darker Blue
        Background = Color3.fromRGB(10, 12, 25),     -- Dark Blue-Black
...
-- Known game IDs with script URLs
local GAMES = {
    -- Blox Fruits
...
-- If not found by ID, try auto-detection by name
...
-- If game found, set script URL
if gameData then
    Config.ScriptToLoad = gameData.s
    Config.Subtitle = Config.Subtitle .. " | " .. gameData.n
else
    -- No game found - kick player
...
task.spawn(function()
    ...
    if success then
        PlaySound("Success")
        updateStatus("ELITE HUB LOADED! 🥀", true)
